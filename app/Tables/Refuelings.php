        ...
        $table
            ...
            ->column('tyres', sortable: true, as: function ($tyres) {
                if ($tyres == 'summer_tyres') {
                    $tyres = '<span class="material-symbols-outlined">sunny</span>';
                } elseif ($tyres == 'winter_tyres') {
                    $tyres = '<span class="material-symbols-outlined">ac_unit</span>';
                } elseif ($tyres == 'all_season_tyres') {
                    $tyres = '<span class="material-symbols-outlined">sunny_snowing</span>';
                }
            ...
            ->column('climate_control', sortable: true, as: function ($climate_control) {
                ...
                $iconMap = [
                    'airconditioning' => '<span class="material-symbols-outlined">ac_unit</span>',
                    'heater' => '<span class="material-symbols-outlined">local_fire_department</span>',
            ...
            ->column('routes', sortable: true, as: function ($routes) {
                ...
                $iconMap = [
                    'city' => '<span class="material-symbols-outlined">location_city</span>',
                    'country_roads' => '<span class="material-symbols-outlined">landscape</span>',
